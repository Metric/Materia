      ...
      if( _model.Orientation == Orientation.Horizontal )
      {
        if( _model.ContainsChildOfType<LayoutDocumentPane, LayoutDocumentPaneGroup>() )
        {
          for( int i = 0; i < _model.Children.Count; i++ )
          {
            ...
            if( childPositionableModel != null && childContainerModel != null &&
                ( childContainerModel.IsOfType<LayoutDocumentPane, LayoutDocumentPaneGroup>() ||
                 childContainerModel.ContainsChildOfType<LayoutDocumentPane, LayoutDocumentPaneGroup>() ) && childPositionableModel.DockWidth == null )
            {
              childPositionableModel.DockWidth = new GridLength( 1.0, GridUnitType.Star );
            }
            else if( childPositionableModel != null && childPositionableModel.DockWidth == null )
            {
        ...
        else
        {
          ...
          {
            var childPositionableModel = _model.Children[ i ] as ILayoutPositionableElement;
            if( childPositionableModel.DockWidth == null )
            {
              childPositionableModel.DockWidth = new GridLength( 1.0, GridUnitType.Star );
            }
          }
      ...
      else
      {
            if (_model.ContainsChildOfType<LayoutDocumentPane, LayoutDocumentPaneGroup>())
            {
                for (int i = 0; i < _model.Children.Count; i++)
                {
                    ...
                    if (childPositionableModel != null && childContainerModel != null &&
                        (childContainerModel.IsOfType<LayoutDocumentPane, LayoutDocumentPaneGroup>() ||
                            childContainerModel.ContainsChildOfType<LayoutDocumentPane, LayoutDocumentPaneGroup>()) && childPositionableModel.DockHeight == null)
                    {
                        childPositionableModel.DockHeight = new GridLength(1.0, GridUnitType.Star);
                    }
                    else if (childPositionableModel != null && childPositionableModel.DockHeight == null)
                    {
                        var childPositionableModelWidthActualSize = childPositionableModel as ILayoutPositionableElementWithActualSize;
            ...
            else
            {
                  ...
                  {
                        var childPositionableModel = _model.Children[ i ] as ILayoutPositionableElement;
                        if( childPositionableModel.DockHeight == null )
                        {
                          childPositionableModel.DockHeight = new GridLength( 1.0, GridUnitType.Star );
                        }
                  }
