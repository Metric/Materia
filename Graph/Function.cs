...
namespace Materia.Graph
{
    public class Function : Graph
    {
        ...
        public delegate void FunctionParentSet(Function g);
        ...
        public virtual bool BuildShader()
        {
            ...
            Shader = GLShaderCache.CompileCompute(lastShaderCode);
        ...
        public static string BuildShaderParam(ParameterValue param, bool isUniform = false, bool isCustom = false)
        {
            string type = "";
        ...
        public static void BuildShaderParam(ParameterValue param, StringBuilder builder, bool isUniform = false, bool isCustom = false)
        {
            string type = "";
        ...
        protected static string BuildShaderParamValue(ParameterValue param)
        {
            ...
            else if (param.Type == NodeType.Float)
            {
                try
                {
                    return param.Value.ToFloat().ToCodeString() + ";\r\n";
                }
                catch (Exception e)
                {
                    Log.Error(e);
        ...
        public string GetParentGraphShaderParams(bool isUniform = false, Dictionary<string, object> seen = null)
        {
            ...
            try
            {
                ...
                if (p != null)
                {
                    ...
                    for (int i = 0; i < count; ++i)
                    {
                        ParameterValue param = p.CustomParameters[i];
